...
namespace Wayfarer.BroadCast.Server
{
	...
	public class ServerForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.lbMonitor.SelectionMode = System.Windows.Forms.SelectionMode.MultiSimple;
...
//							WellKnownObjectMode.Singleton);		
            ...
            #region 服务端订阅客户端事件
            //HttpChannel channel2 = new HttpChannel(8088);
            //ChannelServices.RegisterChannel(channel2);

            RemotingConfiguration.RegisterWellKnownServiceType(
                typeof(UpCastObj), "UpCastMessage.soap", WellKnownObjectMode.Singleton);
	    ...
	    public void OnUpCastEvent(string msg)
	    {
            ...
            lbMonitor.Items.Add(msg + "--rcv time--" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
	    }
